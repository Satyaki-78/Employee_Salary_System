...
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DataEnvironment3 
   ...
   _ExtentY        =   11880
   FolderFlags     =   1
   TypeLibGuid     =   "{542957E0-8D4A-420F-AE5B-F7B59525D460}"
   TypeInfoGuid    =   "{D64E65DF-CE7C-4ECB-9D0E-E2DF96A3A298}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   BeginProperty Connection1 
      ...
      ConnDispId      =   1001
      SourceOfData    =   3
      ConnectionSource=   "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\Salary System\SalarySystem11\Infosys.mdb;Persist Security Info=False"
      Expanded        =   -1  'True
      QuoteChar       =   96
      SeparatorChar   =   46
   EndProperty
