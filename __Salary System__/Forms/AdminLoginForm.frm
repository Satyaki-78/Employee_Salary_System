...
rs.Open "SELECT * FROM AdminUsers", conn, adOpenStatic, adLockReadOnly
...
If rs("AdminName") = username And rs("Password") = password Then
userFound = True
Exit Do
...
MsgBox "Authorized Admin User. Login Successfull !!"
Unload Me
Else
MsgBox "Login Failed. No record with the AdminName and Password found !!"
End If
