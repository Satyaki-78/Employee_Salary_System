...
Begin VB.Form Form201 
   Caption         =   "Admin Salary Table Delete Form"
   ClientHeight    =   9090
   ClientLeft      =   105
   ClientTop       =   435
   ClientWidth     =   17415
   Icon            =   "AdminSalaryDeleteForm.frx":0000
   LinkTopic       =   "Form2"
   ScaleHeight     =   9090
   ScaleWidth      =   17415
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "AdminSalaryDeleteForm.frx":1084A
      ...
      TabPicture(1)   =   "AdminSalaryDeleteForm.frx":10866
      ...
      TabPicture(2)   =   "AdminSalaryDeleteForm.frx":10882
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   600
         Left            =   8640
         MouseIcon       =   "AdminSalaryDeleteForm.frx":1089E
         TabIndex        =   19
         Top             =   240
         Width           =   1455
      End
...
If empFound = True And Search_Salary_Table = True Then
...
End If
Else
MsgBox "Cannot Delete Record !! This record doesn't exist."
End If
Call ClearAllEntries
