...
Begin VB.Form Form2 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "SalaryTableForm.frx":1084A
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Command4"
      Tab(0).Control(1)=   "Text33"
      Tab(0).Control(2)=   "Text32"
      Tab(0).Control(3)=   "Text31"
      Tab(0).Control(4)=   "Text26"
      Tab(0).Control(5)=   "Text19"
      Tab(0).Control(6)=   "Text18"
      Tab(0).Control(7)=   "Text17"
      Tab(0).Control(8)=   "Text16"
      Tab(0).Control(9)=   "Text15"
      Tab(0).Control(10)=   "Text14"
      Tab(0).Control(11)=   "Label76"
      Tab(0).Control(12)=   "Label34"
      Tab(0).Control(13)=   "Label33"
      Tab(0).Control(14)=   "Label32"
      Tab(0).Control(15)=   "Label27"
      ...
      TabPicture(1)   =   "SalaryTableForm.frx":10866
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Text23"
      Tab(1).Control(1)=   "Command5"
      Tab(1).Control(2)=   "Text28"
      Tab(1).Control(3)=   "Text27"
      Tab(1).Control(4)=   "Text25"
      Tab(1).Control(5)=   "Text24"
      Tab(1).Control(6)=   "Text22"
      Tab(1).Control(7)=   "Text21"
      Tab(1).Control(8)=   "Text20"
      ...
      TabPicture(2)   =   "SalaryTableForm.frx":10882
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   600
         Left            =   8640
         MouseIcon       =   "SalaryTableForm.frx":1089E
         TabIndex        =   19
         Top             =   240
         Width           =   1455
      End
...
Call UpdateUserActivity("ADD", "Salary", Text1.Text)
...
Call UpdateUserActivity("SEARCH EMPLOYEE", "Salary", Text1.Text)
Exit Sub
...
Call UpdateUserActivity("SEARCH SALARY", "Salary", Text1.Text)
Else
...
Call UpdateUserActivity("UPDATE SALARY", "Employee", Text1.Text)
