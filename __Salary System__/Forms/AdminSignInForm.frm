...
rs.Open "AdminUsers", gCon, adOpenDynamic, adLockOptimistic, adCmdTable
...
MsgBox "Admin User already exists. Cannot Sign In Duplicate Admin User !!"
...
Call AddRecord
MsgBox "New Admin User Successfully Signed In !!"
Call UpdateUserActivity("SIGNIN", "AdminUsers", Text1.Text)
Unload Me
End If
